...
and \path{org.apache.samza.task.StreamTask} Java interfaces. Default systems exist in the Samza project, and may be
...
a lot of default configuration options, by implementing the \path{backtype.storm.topology.base.BaseRichSpout} interface.
...
\path{org.apache.spark.streaming.StreamingContext} class. Processing performed on DStreams are generally programmed in
