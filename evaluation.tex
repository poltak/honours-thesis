...
The results for the system start-up time test can be seen in~\figref{fig:pipeline_whole}.
...
Configuration in Storm is also kept separate of the logic written in source code, hence also does not require recompilation
...
Samza has shown to perform badly in almost all the tests, apart from ease of extensibility where it beat Spark Streaming.
